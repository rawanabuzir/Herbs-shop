...
<body>
		...
		<div class="dropdown">
			...
			<ul class="dropdown-menu etc">
				...
				if (isset($_SESSION['phonenumber'])) {
					...
					echo "<li class='options' role='presentation'><a role='menuitem' tabindex='-1' href= 'Farmers.php'><label class='makeitgreen'>herbest</label></a></li>";
	...
	<div class="headerdown">
		<div id="show">
			...
			<div class="sel3 sel">
				<button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">HERBS </i>
					<span class="caret"></span></button>
				<ul class="dropdown-menu ">
					<?php getFruits(); ?>
				</ul>
	...
	<div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>Fresh herbs</b></label></div>
	<div id="vegs">
	...
	<div class="morefooter">
		<div class="call">
			...
			<a href="#" style="color:black;">+9628444444</a>
		</div>
	...
	<div class="instaid">
		...
		<div class="gmailid">
			<a href="#" class="hypher" style="color:black;">Rawan@gmail.com</a></div>

	</div>


	<div class="copy">
		<h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.Rawan.com</h5>
	</div>
</body>
