...
<table>
        <tr id="protitle">
            ...
            <td>
                <div class="grp2">
                    ...
                    <div class="col4">
                    <label class="text1" name="product_title" >078444444</label>            </div>
        ...
        <tr id="protitle">
            <td>
                <div class="grp1">
                    ...
                    <div class="col2"><label class="text1" name="product_title" required>cc</label>
            </td>
            </div>
            </div>
            <td>
     ...
     <div class="morefooter">
          ...
          <div class="call">
               ...
               <a href="#" style="color:black;">+96278444444</a>
          </div>
