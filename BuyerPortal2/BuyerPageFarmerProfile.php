...
<head>
    ...
    <title>phytotherapist Details</title>
...
<div class=" flex-row-reverse right ">
                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-top:35px;">
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="iconsmall.png" style="width: 28px; margin-bottom:  10px;"><b> ..sammar</b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" style="margin-left:-9%;"><img src="phoneicon.jpg" style="width: 32px; margin-bottom:  10px;"><b> 078444444 </b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="location.jpg" style="width: 32px; margin-bottom:  10px;"><b> jordan , amman</b></h4>
                                </span>
                            </div>
                        </div>
					</div>
    ...
    <div class="text-center"><h3 style="padding:5px; margin-top:20px;">phytotherapist All Products</div>  
    <hr>           
    <div class="container">                
            ...
            <div class='col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4'>
                <div class='card pb-1 pl-1 pr-1 pt-0' style='height:542px'>
                    ...
                    <div class='card-body pb-0'>
                        ...
                        <p class='card-text mb-2 font-weight-bold'>PRICE:- $product_price JD/kg</p>
                        <div class='row'>
               ...
               <div class="container">
                    ...
                    <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                              <p><u><a href="#">SAMAR Corporation</a></u>SAMMAR</p>
