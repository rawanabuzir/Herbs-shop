    ...
    if (isset($_GET['id'])) {
        ...
        while ($rows = mysqli_fetch_array($run_query)) {
            ...
            if ($product_delivery == "yes") {
                $product_delivery = "Delivery by phytotherapists";
            } else {
                $product_delivery = "Delivery by phytotherapists Not Available";
            }
                    ...
                    <div class='row'>
                        ...
                        <div class='col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12 text-white' style='background-color:#292b2c;'>
                            ...
                            <div class='details mt-1 text-center'>
                                ...
                                <br>
                                <h4 style='color:goldenrod' class='text-center '>Get In touch with us</h4>
                                <a href='BuyerPageFarmerProfile.php' class='btn btn-warning border-secondary  chat' style='color:black;padding:2px;'><b> View phytotherapists Profile <i class='fas fa-id-card-alt pl-1'></i> </b></a>
