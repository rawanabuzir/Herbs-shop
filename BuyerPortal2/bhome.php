...
<head>
    ...
    <script>
        function state() {
            ...
            if (a === '31') {
                var array = ['jordan', 'jordan'];
            } else if (a === '01') {
                var array = ['jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan', 'jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan'];
            } else if (a === '02') {
                var array = ['jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan', 'jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan'];
            } else if (a === '03') {
                var array = ['jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan', 'jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan'];
                ...
                var array = [ 'jordan','jordan', 'jordan', 'jordan'];
            } else if (a === '37') {
                var array = ['jordan'];
            } else if (a === '42') {
                var array = ['North jordan ', 'South jordan'];
            } else if (a === '34') {
                var array = ['jordan & jordan jordan'];
            } else if (a === '36') {
                var array = ['jordan', 'jordan'];
            } else if (a === '23') {
                var array = ['jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan', 'jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan'];
                ...
                var array = ['West jordan ', 'South jordan ', 'jordan  *', 'jordan '];
            } else if (a === '38') {
                var array = ['jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan', 'jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan'];
            } else if (a === '32') {
                var array = ['jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan', 'jordan', 'jordan', 'jordan','jordan', 'jordan', 'jordan'];
...
<body>
    ...
    <div class="container">
        <div class="text-center">
            ...
            <h1 id="headings" class="guard"><span><b>Fresh Herbs </b></span>
            </h1>
        </div>
    ...
    <div class="container">
        <div class="text-center">
            <!-- <h2 id="headings" class="destext">Fresh fruits</h2> -->
            <h1 id="headings" class="guard"><span><b>BSET HERBS </b></span>
            </h1>
        </div>
