...
<nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse left ">
            ...
            <div class="p-2">
                <div class="icon2">
                    ...
                    <span id="icon" style="color:orange"> 5 </span>
                </div>
            </div>
            <div class="p-2 ml-5"><i class='far fa-user-circle' style='font-size:30px; color: orange;margin-top:2px; visibility:hidden;'></i></div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="input-group mb-1 ml-2 searchbox">
                ...
                <input type="text" class="form-control " id="inlineFormInputGroup" placeholder="Search for herbs,Treatment or recipe ">
            </div>
            <div style="color:orange" class="text-success  logins ">Login</div>
            <div class="list-group moblists">
                ...
                <a href="#" class="list-group-item list-group-item-action" style="background-color:#292b2c;text-align:center;color:goldenrod">phytotherapists</a>
        ...
        <div class=" flex-row-reverse right ">
            ...
            <div class="dropdown p-2 settings ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item " style="padding-right:-20px;" href="#">phytotherapists</a>
